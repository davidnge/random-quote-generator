...
function quoteJson() { $.ajax({
        ...
        success: function(data) { var l = JSON.parse(data);
                                    ...
                                    $('.tweet-quote').attr('href','https://www.twitter.com/intent/tweet?hashtag=quotes&text='+encodeURIComponent(newQuote));
                                },
        error: function(err) { alert(err); },
        beforeSend: function(xhr) {
            xhr.setRequestHeader("X-Mashape-Authorization", "q0W1uYyYXimshGkoYUZylOxPCjwrp1SYE1cjsnRkQYdQjS8nM4"); 
        }
    });
